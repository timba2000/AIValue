...
import { generateAndExecuteQuery, isDataQuestion } from "../services/textToSql.js";
...
router.post("/chat", async (req: Request, res: Response) => {
  try {
    ...
    if (isDataQuestion(lastUserMessage)) {
      console.log(`[AI] Detected data question, generating and executing SQL...`);
